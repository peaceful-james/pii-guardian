...
config :pii_guardian, :anthropic_api_key, get_env_var.("PII_GUARDIAN_ANTHROPIC_API_KEY")
...
if config_env() == :prod do
  ...
  config :pii_guardian, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
